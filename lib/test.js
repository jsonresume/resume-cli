...
function validate(resumePath, resumeData, callback) {
    console.log('\n  running validation tests on ' + resumePath + ' ... \n');
    resumeSchema.validate(resumePath, resumeData, function(report, errs) {
        if (errs) {
