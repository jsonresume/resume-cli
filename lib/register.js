...
var spinner = new Spinner('attempting to register..');
    ...
    request
        ...
        .end(function(error, response) {
            ...
            if (response.body.message === 'success') {
                spinner.stop();
                console.log('You have been successfully registered.'.green);
                console.log('You can now use these credentials'.cyan, 'resume publish');
            }
