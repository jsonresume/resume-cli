...
function register(resumeJson) {
    ...
    read({
        ...
        read({
            ...
            if (!validEmail(email)) {
                console.log('Please enter a valid email format.'.red);
                process.exit();
            }
            if (er) {
                console.log('');
    ...
    request
        ...
        .end(function(error, response) {
            ...
            if (error) {
                ...
                console.log('Success! You are now registered at:'.green, 'http://jsonresume.org');
                console.log('You can now type'.cyan, 'resume publish');
