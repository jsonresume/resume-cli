    ...
    function(er, name) {
      ...
      read(
        ...
        function(er, email) {
          ...
          console.log("");
          console.log(
            "To generate a formatted .html .md or .txt resume from your resume.json"
          );
          console.log(
            "type: `resume export [someFileName]` including file extension eg: `resume export myresume.html`"
          );
          console.log(
            "\nYou can optionally specify an available theme for html resumes using the --theme flag."
          );
          console.log("Example: `resume export myresume.html --theme flat`");
          console.log(
