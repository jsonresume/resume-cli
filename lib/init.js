...
function fillInit() {
    ...
    read({
        ...
        read({
            ...
            console.log('Examples: `resume export myresume.pdf --theme crisp`');
            console.log('Examples: `resume export myresume.html --theme traditional`');
            console.log('available themes: modern, traditional, crisp');
